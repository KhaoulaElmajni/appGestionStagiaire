...
if($reste===0)
    ...
    $nbrPage=floor($nbrUser/$size)+1;//floor= la partie entiered'un nbr decimale
?>
<!DOCTYPE HTML>
<html>
    <head>
    ...
    <?php include("menu.php"); ?>
        <div class="container">
          <div class="panel panel-success margetop">
            ...
            <div class="panel-heading">Liste des utilisateurs(<?php echo $nbrUser ?> utilisareurs)</div>
                <div class="panel-body">
                        ...
                        <tbody>
                              <?php while($user=$resultatUser->fetch()){ ?>
                               <tr class="<?php echo $user['etat']==1?'success':'danger'?>">
                                   ...
                                   <td> 
                                          <a href="editerUtilisateur.php?idUser=<?php echo $user['idutilisateur'] ?>">
                                       <span class="glyphicon glyphicon-edit" ></span>
                                              </a>
                                       &nbsp; &nbsp;
                                          <a onclick="return confirm('etes-vous sur de vouloir supprimer cet utilisateur')"
                                             href="supprimerUtilisateur.php?idUser=<?php echo $user['idutilisateur'] ?>">
                                       <span class="glyphicon glyphicon-trash" ></span>
                                       </a>
                                       &nbsp; &nbsp;
<a href="activerUtilisateur.php?idUser=<?php echo $user['idutilisateur'] ?>&etat=<?php echo $user['etat']  ?>">

                                       <?php
                                       if($user['etat']==1) echo '<span class="glyphicon glyphicon-remove" ></span>'; 
                                        else  
