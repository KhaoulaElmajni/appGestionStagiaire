...
<HTML>
    <HEAD>
        <meta charset="utf-8"> 
        <tit> Edition d'un Stagiaire </tit>
                ...
                <div class="panel-body">
                    <form method="post" action="updateStagiaire.php" class="form" enctype="multipart/form-data">
                      ...
                      <label for="prenom"> Prénom :</label> 
                       <input type="text" name="prenom" placeholder="taper le prénom " class="form-control" value="<?php echo $prenom ?>"/>
                         </div>
                        <div class="form-group">
                      ...
                      <label for="civilite"> civilité :</label> 
                            ...
                            <?php if($civilite==="M") echo"checked" ?> checked/> M </label>
